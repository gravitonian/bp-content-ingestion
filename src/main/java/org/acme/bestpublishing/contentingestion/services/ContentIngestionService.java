 ...
 * as individual chapter XHTML files and images/pictures for the different chapters, and then store them in Alfresco.
 *
...
public interface ContentIngestionService {
    /**
     * Extracts and imports all the content in the ZIP such as chapter XHTMLs, artwork, supplementary etc
     *
